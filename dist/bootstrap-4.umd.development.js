(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@rjsf/core'), require('react'), require('react-bootstrap/Button'), require('@react-icons/all-files/bs/BsPlus'), require('react-bootstrap/Row'), require('react-bootstrap/Col'), require('react-bootstrap/Container'), require('@rjsf/utils'), require('react-bootstrap/Form'), require('react-bootstrap/Card'), require('react-bootstrap/ListGroup'), require('@react-icons/all-files/io/IoIosRemove'), require('@react-icons/all-files/ai/AiOutlineArrowUp'), require('@react-icons/all-files/ai/AiOutlineArrowDown'), require('react-bootstrap/FormControl'), require('react-bootstrap/InputGroup')) :
  typeof define === 'function' && define.amd ? define(['exports', '@rjsf/core', 'react', 'react-bootstrap/Button', '@react-icons/all-files/bs/BsPlus', 'react-bootstrap/Row', 'react-bootstrap/Col', 'react-bootstrap/Container', '@rjsf/utils', 'react-bootstrap/Form', 'react-bootstrap/Card', 'react-bootstrap/ListGroup', '@react-icons/all-files/io/IoIosRemove', '@react-icons/all-files/ai/AiOutlineArrowUp', '@react-icons/all-files/ai/AiOutlineArrowDown', 'react-bootstrap/FormControl', 'react-bootstrap/InputGroup'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@rjsf/bootstrap-4"] = {}, global.core, global.React, global.Button, global.BsPlus, global.Row, global.Col, global.Container, global.utils, global.Form$1, global.Card, global.ListGroup, global.IoIosRemove, global.AiOutlineArrowUp, global.AiOutlineArrowDown, global.FormControl, global.InputGroup));
})(this, (function (exports, core, React, Button, BsPlus, Row, Col, Container, utils, Form$1, Card, ListGroup, IoIosRemove, AiOutlineArrowUp, AiOutlineArrowDown, FormControl, InputGroup) { 'use strict';
...
//# sourceMappingURL=bootstrap-4.umd.development.js.map
